 ...
 */
public class ClassificacaoDecimalDireitoCadastroUI extends javax.swing.JInternalFrame {
    ...
    public ClassificacaoDecimalDireitoCadastroUI() throws Exception {
        initComponents();
        inicializarComponentes();
    }
    
    public ClassificacaoDecimalDireitoCadastroUI(ClassificacaoDecimalDireito cddEmEdicao) throws Exception {
        this();
        
//      Defini o nome do títilo da tela.
        dashboardUI.setJLabelNomeTela("Editar ClassificacaoDecimalDireito");     
...
//      Defini o nome do títilo da tela.
        dashboardUI.setJLabelNomeTela("Cadastrar ClassificacaoDecimalDireito");
...
//      Maximiza o JInternalFrame para o tamanho do JDesktopPane (pai);
    ...
    public void preencherCamposDaTelaComClassificacaoDecimalDireitoEditando(ClassificacaoDecimalDireito cddEmEdicao) {
        jTextFieldCodigo.setText(cddEmEdicao.getCodigoCDD());
        jTextFieldDescricao.setText(cddEmEdicao.getDescricao());
        jCheckBoxAtivo.setSelected(cddEmEdicao.isAtivo());
    }
    ...
    private void initComponents() {
        ...
        jButtonIncluirSalvarCDD.setText("Inlcuir");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jCheckBoxAtivo)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, 436, Short.MAX_VALUE)
    ...
    private void jButtonIncluirSalvarCDDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIncluirSalvarCDDActionPerformed
        ...
        String codigoCDD = jTextFieldCodigo.getText().trim();
        String descricao = jTextFieldDescricao.getText().trim();
        
        if (descricao.equals("")|| codigoCDD.equals("")){
...
//              Insere os novos valores
            ...
            UtilComponentes.limparCampos(jTextFieldDescricao, jTextFieldCodigo);
    ...
    private void jButtonSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSairActionPerformed
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(ClassificacaoDecimalDireitoCadastroUI.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }        
