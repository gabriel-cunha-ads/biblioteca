...
public class LivroCadastroUI extends javax.swing.JInternalFrame {
    ...
    public LivroCadastroUI(LivroCadastroUI livroCadastroUI) {
        
        boolean editandoLivro = true;
...
//      Obtém a instancia do dashboard, inicializa o título da janela.
        ...
        dashboardUI.setJLabelNomeTela("Cadastro Livro");
...
//      Obtém a instancia do JDesktopPane
    ...
    private void preencherLivroParaEditar(LivroCadastroUI livroCadastroUI) {
        System.out.println(livroCadastroUI);
    }    
